...
import { useSignUp } from "../services/useAuthentication";
  ...
  return (
    <main className="h-screen w-full flex items-center justify-center">
      <form
        ...
        className="border border-black w-1/2 h-1/2 flex flex-col gap-2 rounded-md items-center justify-center"
      >
        <h1 className="mb-5 text-4xl uppercase">Sign up</h1>
        <input
          onChange={(e) =>
        ...
        <Link
          to={"/login"}
          className={`${
            isSigningUp && "opacity-25"
          } text-black text-sm underline hover:opacity-50`}
        >
